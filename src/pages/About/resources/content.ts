export const content = {
	...
	currently: {
		...
		titleEmoji: '🚀',
		description: [
			"I'm currently at Toyota, where I work with a dedicated team of designers and developers to build the PRIME Design System. PRIME serves the internal Supply Chain and Fufillment product teams, with big plans for the future.",
