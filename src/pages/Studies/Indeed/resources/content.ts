...
export const content = {
    header: {
        ...
        description: 'I joined Indeed as a UX Designer to support their internal design system team during a period of rapid growth. Over the course of several months, I helped evolve the system\'s component library, improved adoption workflows, and guided cross-functional teams on scalable, accessible UI implementation.',
        chips: [
